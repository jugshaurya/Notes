...
- If a player can move to a losing position then he is in a winning position.
- If a player can move only to the winning positions then he is in a losing position.

### Examples of Subtraction Games
...
- Graphs will always be undirected and DAG.
